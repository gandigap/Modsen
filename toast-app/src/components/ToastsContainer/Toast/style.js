...
export const StyledToastContainer = styled.div`
  ...
  min-height: 40px;
  border-radius: 10px;
  animation: .5s ${props => props.animation ===TOAST_ANIMATIONS.vertical ? "start-y" :  "start-x"} 1s ;
  ...
  &.animation-end{
    animation: .5s ${props => props.animation ===TOAST_ANIMATIONS.ease ? "end-y" :  "end-x"} 1s;
  } 
